...
namespace ft {
	...
	public:
		...
		iterator &operator=(const iterator &obj)
			{ this->value = obj.value; return *this; }
		iterator operator++(int)
			{ iterator tmp(*this); value++; return tmp; }
		iterator operator--(int)
			{ iterator tmp(*this); value--; return tmp; }
		iterator &operator++()
			{ value++; return *this; }
	...
	public:
		...
		node_iterator	&operator=(const node_iterator &obj)
			{ node = obj.node; return *this; }
		node_iterator	operator++(int)
			{ node_iterator tmp(*this); next(); return tmp; }
		node_iterator	&operator++()
			{ next(); return *this; }
		node_iterator	operator--(int)
			{ node_iterator tmp(*this); prev(); return tmp; }
		node_iterator	&operator--()
			{ prev(); return *this; }
		...
		bool operator!=(node_iterator const &obj) const
			{ return node != obj.node; };
		bool operator>(node_iterator const &obj) const
			{ return node->pair > obj.node->pair; };
		bool operator<(node_iterator const &obj) const
			{ return obj.node->pair > node->pair; };
		bool operator<=(node_iterator const &obj) const
			{ return node->pair <= obj.node->pair; };
		bool operator>=(node_iterator const &obj) const
			{ return node->pair >= obj.node->pair; };
	...
	public:
		...
		reverse_iterator operator++(int)
			{ reverse_iterator tmp(*this); iterator--; return tmp; }
		reverse_iterator& operator--()
			{ ++iterator; return *this; }
		reverse_iterator operator--(int)
			{ reverse_iterator tmp(*this); iterator++; return tmp; }
		reverse_iterator operator+(difference_type n)
			const { return reverse_iterator(iterator - n); }
		reverse_iterator& operator+=(difference_type n)
